...
export function BrandingStrip({ flowerLeftSrc, flowerRightSrc }: Props) {
  ...
  // ✅ Сначала получаем active, потом считаем isCatalogActive
  const params = new URLSearchParams(search);
  const active = params.get("category");
  const isCatalogActive = pathname === "/catalog" && !active; // активна, если мы на /catalog без выбранной категории
