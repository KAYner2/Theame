    ...
    <div className="container px-6 py-8">
      ...
      <div className="mt-12 bg-white p-6 md:p-10 rounded-lg shadow-soft text-[#7e7e7e]">
        <h2 className="text-2xl font-semibold mb-4 text-[#000]">
          Почему выбирают The Ame для заказа букетов в Сочи
        </h2>
        <ul className="list-disc ml-6 space-y-2">
          <li><strong>Свежесть и качество</strong> — работаем только с проверенными поставщиками, собираем букеты из свежих цветов в день заказа.</li>
          <li><strong>Авторские композиции</strong> — создаём уникальные букеты: от лаконичных монобукетов до сложных композиций в коробках и корзинах.</li>
          <li><strong>Фото перед отправкой</strong> — пришлём фото готового букета, чтобы вы были уверены в результате.</li>
          <li><strong>Быстрая доставка по Сочи</strong> — в среднем от 45 минут по городу. Возможна срочная и ночная доставка.</li>
          <li><strong>Удобные фильтры и цены</strong> — подберите букет по категории, составу и бюджету: от мини-форматов до премиум-композиций.</li>
          <li><strong>Поддержка 24/7</strong> — поможем выбрать букет под событие и оформим заказ в мессенджере.</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-10 mb-4 text-[#000]">
          Что можно купить в каталоге The Ame
        </h2>
        <ul className="list-disc ml-6 space-y-2">
          <li>Монобукеты из роз, пионовидных и кустовых роз, гортензий, хризантем, диантусов и других сезонных цветов.</li>
          <li>Авторские сборные букеты в трендовых оттенках и фактурах.</li>
          <li>Композиции в шляпных коробках и корзинах, минималистичные мини-букеты и крупные подарочные варианты.</li>
          <li>Букеты для поводов: день рождения, признание, свадьба, юбилей, корпоративные подарки.</li>
        </ul>

        <p className="mt-8 text-base">
          Доставляем по всему Большому Сочи: Центр, Адлер, Хоста, Сириус, Лоо, Мацеста, Дагомыс, Красная Поляна и другие районы.
          Оформите заказ онлайн — мы бережно соберём и доставим букет точно в срок.
        </p>
      </div>
    </div>
  );
