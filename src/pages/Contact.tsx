                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    {[
                      ...
                      <AccordionItem key={index} value={`delivery-${index}`} className="border-border/50">
                        <AccordionTrigger className="hover:no-underline py-3">
                          <span className="text-foreground font-medium text-sm">{delivery.area}</span>
                        </AccordionTrigger>
                        <AccordionContent className="pb-4">
                          <div className="space-y-3 pl-4">
                            <div className="flex justify-between items-center">
                              <span className="text-sm text-muted-foreground">
                                от {delivery.freeFrom.toLocaleString('ru-RU')} ₽
                              </span>
                            ...
                            <div className="flex justify-between items-center">
                              <span className="text-sm text-muted-foreground">
                                до {delivery.freeFrom.toLocaleString('ru-RU')} ₽
                              </span>
