  ...
  const contactInfo = [
    {
      ...
      title: "Адрес",
      details: ["Г. Сочи, Донская, 10а, 1 этаж, Район Центральный внутригородской"]
    },
    {
              ...
              <Card className="bg-gradient-card border-0 shadow-soft">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    >
                      <a
                        href="https://api.whatsapp.com/message/XQDDWGSEL35LP1?autoload=1&app_absent=0"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center w-full"
                      >
              ...
              <Card className="bg-gradient-card border-0 shadow-soft">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Спальные районы</span>
                    ...
                    <div className="pt-2 border-t">
                      <p className="text-sm text-muted-foreground">
                        Доставка осуществляется в течение 2-3 часов с момента оформления заказа
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="aspect-video rounded-lg overflow-hidden">
                    <iframe 
                      src="https://yandex.ru/map-widget/v1/?ll=39.72813%2C43.610353&z=16&l=map&pt=39.72813,43.610353,pm2rdl"
                      width="100%" 
                      height="100%" 
                      style={{ border: 'none' }}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Г. Сочи, Донская, 10а, 1 этаж,<br />
                          Район Центральный внутригородской
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
