  ...
  return (
    <div className="min-h-screen bg-[#fff8ea]">
      ...
      <Helmet>
        ...
        <meta
          name="keywords"
          content="купить цветы Сочи, доставка цветов Сочи, свежие букеты, премиум букеты, авторские букеты, розы с доставкой, заказать букет, цветы онлайн, цветы в коробках, корзины с цветами, монобукеты, сезонные цветы, доставка по Большому Сочи, букет на подарок, цветочный магазин The Ame, премиальные цветы, доставка цветов за 45 минут"
        />
