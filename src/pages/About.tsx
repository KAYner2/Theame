...
export default function About() {
  ...
  return (
    // ЕДИНЫЙ ПЕСОЧНЫЙ ФОН ДЛЯ ВСЕЙ СТРАНИЦЫ
    <div className="min-h-screen bg-[#fff8ea]">
      {/* Hero без отдельного фона/градиента */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <Badge
                  variant="outline"
                  className="px-4 py-2 rounded-full border-[#819570] text-[#819570]"
                >
            ...
            {/* Лёгкие карточки-статы без «своих» фонов */}
            <div className="grid grid-cols-2 gap-4">
              {[
                { title: '⭐⭐⭐⭐⭐', subtitle: 'Рейтинг' },
                ...
                <Card
                  key={item.title}
                  className="border-0 shadow-soft rounded-xl bg-white/60"
                >
      ...
      {/* Ценности — без отличного фона, тот же песочный */}
      <section className="py-16 sm:py-20">
        <div className="container mx-auto px-4">
              ...
              >
                <CardContent className="p-6 text-center">
                  <div className="mb-4 flex justify-center text-[#819570]">
                    {/* иконки наследуют зелёный через currentColor */}
                    <div className="[&>*]:text-[#819570]">{value.icon}</div>
                  </div>
                  <h3 className="text-xl font-semibold mb-2 text-[#819570]">
                    {value.title}
                  </h3>
                  <p className="text-[#819570]">
                    {value.description}
                  </p>
                </CardContent>
              </Card>
