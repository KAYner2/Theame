...
export default function VariantProductPage() {
  ...
  // Скролл к началу при смене товара
  useEffect(() => {
  ...
  // Фото: если у варианта своё — показываем его; иначе — общее фото товара
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      id: `vp:${product.id}:${current.id}`, // уникально для каждого варианта
