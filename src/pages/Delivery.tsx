...
export default function Delivery() {
  ...
  return (
    <div className="min-h-screen bg-[#fff8ea]">
      {/* Мета-теги для SEO */}
      <Helmet>
        <title>Заказать доставку цветов в Сочи — быстро и с заботой | The Ame</title>
        <meta
          name="description"
          content="Срочная доставка цветов по Сочи — от 45 минут. Свежие букеты, бережная упаковка и внимание к каждой детали."
        />
        <meta
          name="keywords"
          content="доставка цветов Сочи, доставка букетов, свежие цветы с доставкой, доставка 24/7, срочная доставка цветов, доставка цветов от 45 минут, доставка цветов в Сириус, доставка цветов в Адлер, доставка цветов в Хосту, доставка цветов в Красную Поляну, цветы в подарок, букет для девушки, цветы для мамы, букет на день рождения, цветы сегодня, доставка цветов в отель, гарантия свежести 3 дня, премиальные букеты"
        />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-white p-6 md:p-10 rounded-lg shadow-soft text-[#7e7e7e]">
            ...
            <ul className="list-disc ml-6 space-y-2">
              ...
              <li>Гарантия свежести — 3 дня после покупки. Если цветы увянут, мы бесплатно заменим букет.</li>
            </ul>
